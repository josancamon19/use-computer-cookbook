...
| `macosworld/` | The [macOSWorld](https://github.com/microsoft/MacOSWorld) benchmark repo | `uv run python -m runner.adapters.macosworld.run_adapter --macosworld-root <path> --task-dir datasets/macosworld_ready` |
